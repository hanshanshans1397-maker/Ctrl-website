  ...
  return (
    <>
      ...
      >
        ...
        <img src="/photos/workshopy.webp" alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover z-0 max-sm:hidden" fetchpriority="high" decoding="async" />
        ...
        */}
        ...
        <div className="hero-mobile-head hidden max-sm:block relative w-full shrink-0 bg-dark">
          ...
          <img src="/photos/workshopy.webp" alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover" fetchpriority="high" decoding="async" />
        ...
        <div className="hero-mobile-body relative z-[3] max-w-[1100px] max-sm:px-5 max-sm:max-w-full">
          ...
          >
            <p className="cs max-w-[480px] text-lg leading-[1.65] font-light text-[rgba(245,245,243,0.7)] max-sm:text-[15px]">
              Moderní workshopy zaměřené na AI, média, digitální gramotnost a
              budoucnost vzdělávání. Přímo na vaší škole. Zdarma.
            </p>
            <p className="en max-w-[480px] text-lg leading-[1.65] font-light text-[rgba(245,245,243,0.7)] max-sm:text-[15px]">
              Modern workshops focused on AI, media, digital literacy and the
          ...
          <div className="about-2col grid grid-cols-2 items-start gap-[100px] max-lg:grid-cols-1 max-lg:gap-12 max-sm:gap-10">
            <div className="rev">
              ...
              <p className="en mb-5 text-base leading-[1.85] font-light text-mid">
                Algorithms decide what we see. Deepfakes replace reality.
                Disinformation spreads faster than facts. And the education
              ...
              <p className="en mb-5 text-base leading-[1.85] font-light text-mid">
                ...
                every month. CTRL Workshops bridges this gap. Practically,
                interactively, without unnecessary theory.
              </p>
              <p className="cs text-base leading-[1.85] font-light text-mid">
                <strong className="font-medium text-dark">
                  Digitální gramotnost už není volitelná. Je to základní
                  dovednost pro život v moderní společnosti.
                </strong>
              </p>
              <p className="en text-base leading-[1.85] font-light text-mid">
                <strong className="font-medium text-dark">
                  Digital literacy is no longer optional. It is a fundamental
                  skill for life in modern society.
                </strong>
              </p>
            </div>
          ...
          <div className="flex flex-col sep-stack">
            ...
            <div className="rev d1 grid grid-cols-[200px_1fr] items-start gap-12 bg-bg px-11 py-10 transition-colors duration-300 hover:bg-bg2 max-lg:grid-cols-1 max-lg:gap-4 max-sm:px-5 max-sm:py-7">
              <div className="pt-1">
                ...
                >
                  ...
                  />
                  <path
                    d="M3 10.5L5 12.5M13 10.5L11 12.5"
                    strokeLinecap="round"
                    opacity="0.4"
                  />
                </svg>
            ...
            <div className="rev d1 grid grid-cols-[200px_1fr] items-start gap-12 bg-bg px-11 py-10 transition-colors duration-300 hover:bg-bg2 max-lg:grid-cols-1 max-lg:gap-4 max-sm:px-5 max-sm:py-7">
              <div className="pt-1">
                ...
                >
                  ...
                  <path
                    d="M5.5 5.5h5M5.5 7.5h5M5.5 9.5h3"
                    strokeLinecap="round"
                    strokeWidth="0.9"
                    opacity="0.45"
                  />
                  <path
                    d="M5.5 12l1.5 1.5 3-3"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth="1.1"
                  />
            ...
            <div className="rev d2 grid grid-cols-[200px_1fr] items-start gap-12 bg-bg px-11 py-10 transition-colors duration-300 hover:bg-bg2 max-lg:grid-cols-1 max-lg:gap-4 max-sm:px-5 max-sm:py-7">
              <div className="pt-1">
                ...
                >
                  <path
                    d="M8 1.5L2.5 4v5c0 3 2.5 4.8 5.5 5.5 3-.7 5.5-2.5 5.5-5.5V4z"
                    strokeLinejoin="round"
                  />
                  <path
      ...
      <section className="sec bg-bg">
        <div className="inner">
          ...
          <div className="about-2col grid grid-cols-2 items-start gap-[100px] max-lg:grid-cols-1 max-lg:gap-12 max-sm:gap-10">
            <div className="rev">
              <p className="cs mb-5 text-base leading-[1.85] font-light text-mid">
                Workshop přizpůsobujeme věku studentů, tématu které školu zajímá
                a časovým možnostem. Jsme flexibilní. Funguje to pro třídy,
                skupiny i celé ročníky.
              </p>
              <p className="en mb-5 text-base leading-[1.85] font-light text-mid">
                We adapt the workshop to the age of students, the topic the
                school is interested in and time constraints. We are flexible.
                It works for classes, groups and entire year groups.
              </p>
              <p className="cs text-base leading-[1.85] font-light text-mid">
                Pro partnerské školy je workshop zcela zdarma. Dlouhodobá
                spolupráce vítaná.
              </p>
              <p className="en text-base leading-[1.85] font-light text-mid">
                For partner schools the workshop is completely free. Long-term
        ...
        <div className="inner">
          <div className="section-head rev">
            ...
            <h2 className="section-title italic">
              ...
              <span className="en">
                Central Europe as <em>the starting point.</em>
              </span>
            </h2>
          </div>
          <div className="grid grid-cols-3 sep-grid max-md:grid-cols-1">
            <div className="rev d1 bg-bg2 px-10 py-12 max-sm:px-6 max-sm:py-8">
              ...
              <h3 className="en mb-3.5 text-xl font-semibold tracking-[-0.4px] text-dark">
                Central European region
              </h3>
              <p className="cs text-sm leading-[1.75] font-light text-mid">
                Workshopy jsou přizpůsobené kontextu střední Evropy: její
                historii, mediálnímu prostředí a digitálním výzvám regionu.
              </p>
              <p className="en text-sm leading-[1.75] font-light text-mid">
                Workshops are tailored to the Central European context: its
            ...
            <div className="rev d2 bg-bg2 px-10 py-12 max-sm:px-6 max-sm:py-8">
              ...
              <p className="cs text-sm leading-[1.75] font-light text-mid">
                Propojujeme studenty a školy z různých zemí CEE. Sdílení
                zkusenosti a budování mezinárodních kontaktů.
              </p>
              <p className="en text-sm leading-[1.75] font-light text-mid">
                We connect students and schools from different CEE countries.
            ...
            <div className="rev d3 bg-bg2 px-10 py-12 max-sm:px-6 max-sm:py-8">
              ...
              <p className="cs text-sm leading-[1.75] font-light text-mid">
                Cílem je síť škol a organizací, které sdílejí hodnoty digitální
                gramotnosti a kritického myšlení napříč Evropou.
              </p>
              <p className="en text-sm leading-[1.75] font-light text-mid">
                The goal is a network of schools and organizations that share
                the values of digital literacy and critical thinking across
                Europe.
              </p>
            </div>
          </div>
      ...
      <section className="sec bg-bg text-center">
        <div className="inner mx-auto max-w-[700px]">
          ...
          <h2 className="rev en mb-6 text-[clamp(40px,5.5vw,80px)] leading-none font-extrabold tracking-[-3px] text-dark">
            Order a workshop.
          </h2>
          <p className="rev d1 cs mb-10 text-[17px] leading-[1.8] font-light text-mid">
            Pro školy zdarma. Napište nám zprávu a domluvíme se na termínu.
          </p>
          <p className="rev d1 en mb-10 text-[17px] leading-[1.8] font-light text-mid">
            Free for schools. Send us a message and we'll arrange the dates.
          </p>
      ...
      <div className="ticker-wrap-outer">
        <div className="ticker-inner" id="ticker">
          <div className="ticker-item cs">CTRL Workshopy</div>
          <div className="ticker-item en">CTRL Workshops</div>
          <div className="ticker-item cs">AI a každodenní život</div>
          <div className="ticker-item en">AI & Everyday Life</div>
          <div className="ticker-item cs">Mediální gramotnost</div>
          <div className="ticker-item en">Media Literacy</div>
          <div className="ticker-item cs">Deepfaky</div>
          <div className="ticker-item en">Deepfakes</div>
          <div className="ticker-item cs">Kritické myšlení</div>
          <div className="ticker-item en">Critical Thinking</div>
          <div className="ticker-item cs">Digitální bezpečnost</div>
          <div className="ticker-item en">Digital Safety</div>
          <div className="ticker-item cs">Zdarma pro školy</div>
          <div className="ticker-item en">Free for schools</div>
